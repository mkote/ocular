...
The filter bank can be improved by optimizing over a wider variety of sub-bands, by mixing sub-bands with differing spans such as [4-8] and [8-11]. This would increase the complexity of the input space., which in turn would make the optimization of all parameters harder. 