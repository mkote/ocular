...
\begin{itemize}
	\item write about how candidates are selected.
	\item write about expected improvement
	\item make and describe figure on what expected improvement represents
\end{itemize}
