...
def plot_example1():
    ...
    eog_signal1 = eeg_data[3][0][22]
    eog_signal2 = eeg_data[3][0][23]
    eog_signal3 = eeg_data[3][0][24]
    #labels = eeg_data[5][2]
    #n_trials = 48
    m = 11
    ...
    ax[1].plot([x for x in range(0, len(eog_signal1))], eog_signal1, 'r', label='eog:')
    ax[1].plot([x for x in range(0, len(eog_signal2))], eog_signal2, 'b', label='eog:')
    ax[1].plot([x for x in range(0, len(eog_signal3))], eog_signal3, 'g', label='eog:')
